...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/settings/company-profile', [\App\Http\Controllers\SettingsController::class, 'updateCompanyProfile'])->name('settings.company-profile.update');
    Route::put('/settings/business-goals', [\App\Http\Controllers\SettingsController::class, 'updateBusinessGoals'])->name('settings.business-goals.update');
    Route::put('/settings/theme', [\App\Http\Controllers\SettingsController::class, 'updateThemeAndBrand'])->name('settings.theme.update');
    ...
    Route::middleware('boss')->group(function () {
        ...
        Route::get('/analytics/ledger', [\App\Http\Controllers\AnalyticsController::class, 'ledger'])->name('analytics.ledger');
