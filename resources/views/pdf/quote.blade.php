...
<body>
    ...
    <div class="items-container">
        <table class="items-table">
            <thead>
                <tr>
                    <th class="th-desc" width="45%">Item Description</th>
                    <th class="th-price" width="18%">Unit Price</th>
                    <th class="th-qty" width="12%">Quantity</th>
                    <th class="th-total" width="25%">Total</th>
                </tr>
            </thead>
            <tbody>
                @foreach($quote->items as $item)
                    ...
                    <tr>
                        ...
                        <td class="item-qty text-center">{{ str_pad($item->quantity, 2, '0', STR_PAD_LEFT) }}</td>
                        <td class="item-total text-center">{{ $currency }}{{ number_format($lineTotal, 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
